...
def pop_out_data_from_redis():
    r.lpop('dev_data_2').decode('utf-8')
...
def send_data_to_server(data_from_pop):
    ...
    try:
        ...
        sql = "INSERT INTO DevTransaction (DevTypeID, DevID,Data) VALUES (%s, %s, %s)"
